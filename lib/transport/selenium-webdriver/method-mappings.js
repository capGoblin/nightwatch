...
const InputActions = require('./InputActions.js')
...
module.exports = class MethodMappings {
  ...
  async getinputInstance() {
    if (!this.transport.InputInstance) {
      this.transport.InputInstance = await InputActions('firefox');
      this.transport.browsingContextId = await this.transport.InputInstance._driver.getWindowHandle();
      // this.transport.driver = this.InputInstance._driver;
    }
    return this.transport.InputInstance;
  }
    ...
    return {
      ...
      session: {
        ...
        async navigateTo(url) {
          await this.getinputInstance();
          await this.transport.InputInstance._driver.get(url);
